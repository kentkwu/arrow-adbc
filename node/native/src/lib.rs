...
use adbc_client::{
  ...
  GetTableSchemaOptions as CoreGetTableSchemaOptions, QueryOptions as CoreQueryOptions,
  _AdbcConnectionCore as CoreConnection,
  _AdbcConnectionResultIteratorCore as CoreConnectionIterator, _AdbcDatabaseCore as CoreDatabase,
  _AdbcStatementCore as CoreStatement, _AdbcStatementIteratorCore as CoreIterator,
};
